...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        writeSupport.setOnClickListener {
            ...
            messageIntent.putExtra(Intent.EXTRA_EMAIL, arrayOf(getString(R.string.adress_email)))
            messageIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.text_theme))
            messageIntent.putExtra(Intent.EXTRA_TEXT,getString(R.string.message_for_developers))
        ...
        sendIntent.setOnClickListener {
            ...
            shareIntent.putExtra(
                Intent.EXTRA_TEXT,
                getString(R.string.adress_android)
            )
    ...
    private fun saveThemeState(isDarkThemeEnabled: Boolean) {
        ...
        editor.putBoolean("is_dark_theme_enabled", isDarkThemeEnabled)
        editor.apply()
    }
}